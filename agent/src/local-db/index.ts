...
export class SqliteLocalStore implements LocalStore {
  ...
  constructor(options: LocalStoreOptions) {
    ...
    if (options.onSchemaDdl) {
      ...
      this.#database.setAuthorizer((actionCode, objectName, auxiliaryName, databaseName) => {
        if (schemaActions.has(actionCode)) {
          options.onSchemaDdl?.({ actionCode, objectName, auxiliaryName, databaseName });
        }
