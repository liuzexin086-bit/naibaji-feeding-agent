/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 2571cf56dd2f5fa9a52826ceb7a68f36)
...
interface __BaseEnv_Env {
	...
	SUPABASE_URL: "https://fjkjhohbbnnjfofifzmg.supabase.co";
	SUPABASE_PUBLISHABLE_KEY: "sb_publishable_SzGztxZD8kiZiIhtgKCYmg_HHbGhbuo";
	FEEDING_AGENT_CONTAINER: DurableObjectNamespace<import("./src/worker/index").FeedingAgentContainer>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker/index");
		durableNamespaces: "FeedingAgentContainer";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AGENT_ENABLED" | "SOP_ENABLED" | "LLM_PROVIDER" | "LLM_MODEL" | "SUPABASE_URL" | "SUPABASE_PUBLISHABLE_KEY">> {}
}
